...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, category, details, price, image, quantity) VALUES(?,?,?,?,?,?)");
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="quantity"><?= $fetch_products['quantity']; ?> remaining in stock</div>
      <div class="flex-btn">
